...
class Conectar{
    ...
    public function conexion(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	$con = pg_connect("host=186.4.203.54 port=5432 dbname=ad_capremci user=postgres password=.Mdigital.2017 ");
        	if(!$con){
    ...
    public function startFluent(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	try
        	{
        		$pdo = new PDO('pgsql:host=186.4.203.54;port=5432;dbname=ad_capremci', 'postgres', '.Mdigital.2017' );
